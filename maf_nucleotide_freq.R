...
histogram_N_vs_nonN <- ggplot(data = melt(nucleotide_freq_data[,c(3,8:9)]), mapping = aes(x = value)) + geom_histogram() + facet_wrap(~variable, scales = 'free_x') + labs( x = "number of nucleotides")
